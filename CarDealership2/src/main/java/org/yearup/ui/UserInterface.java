...
import org.yearup.dataStorage.ContractFileManager;
import org.yearup.dataStorage.DataManager;
...
public class UserInterface
{
    ...
    public void displayHomeScreen()
    {
        ...
        System.out.println(" 10) Lease/Sell a vehicle");
    ...
    public void processRecordSaleOrLease()
    {
        ...
        int selection = getUserInputInt("What do you want to do?");
        Contract contract;
        switch(selection)
        {
            case 1:
                contract = salesContract(date,name,vehicle);
                dealership.removeVehicle(vehicle);
                break;
            case 2:
                contract = leaseContract(date,name,vehicle);
                dealership.removeVehicle(vehicle);
                break;
            default:
    ...
    private Contract leaseContract(String date, String name, Vehicle vehicle)
    {
        return null;
    }

    private Contract salesContract(String date,String name, Vehicle vehicle)
    {
        return null;
    }
